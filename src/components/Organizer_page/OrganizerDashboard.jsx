            ...
            >
                ...
                <div className="p-6 border-b border-white/5 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="font-bold text-lg leading-tight">Organizer</h1>
                    ...
                    <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-xl p-3 mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <p className="text-xs text-indigo-300 leading-relaxed">
                                You are managing events for <br />
                                <span className="font-bold text-white">{currentUser?.college || 'Your College'}</span>
                            </p>
                        </div>
                    </div>
            ...
            <main className="flex-1 min-w-0 bg-slate-950 relative" style={{ minHeight: '100vh', paddingTop: '64px', overflowX: 'hidden' }}>
                ...
                <div className="lg:hidden sticky top-[64px] z-30 bg-slate-900/80 backdrop-blur-md border-b border-white/5 px-4 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-white">Organizer Panel</span>
                    </div>
                    <div className="w-8 h-8 rounded-full bg-indigo-500/20 flex items-center justify-center">
                        <span className="font-bold text-indigo-400 text-sm">O</span>
                    </div>
                </div>
